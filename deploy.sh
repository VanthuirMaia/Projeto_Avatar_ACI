...
git update-index --assume-unchanged Backend/data/metrics.jsonl 2>/dev/null || true
git update-index --assume-unchanged Backend/data/audit.jsonl 2>/dev/null || true
...
[ -f ./Backend/data/metrics.jsonl ] || touch ./Backend/data/metrics.jsonl
[ -f ./Backend/data/audit.jsonl ]   || touch ./Backend/data/audit.jsonl
